...
if(isset($_POST['project_id'])){
 ...
 <form id="form" class="form-group" method="post" action="./kaiwa.php" cf-form ...>
        ...
        <cf-robot-message cf-questions="Hi! I am Kaiwa"></cf-robot-message>
                 ...
                 <cf-robot-message cf-questions="A chatbot driving employee communications at GravityiLabs."></cf-robot-message> --
...
?> -->
  <fieldset cf-questions="how are you feeling now?"  cf-input-placeholder="select any number of emotions">
    <input type="checkbox" name="mood[]" value="Anxiety" cf-label="Anxiety 😰" />
    <input type="checkbox" name="mood[]" value="Fun"    cf-label="Fun 😀" />
    <input type="checkbox" name="mood[]" value="Fear" cf-label="Fear 😨"/>
    <input type="checkbox" name="mood[]" value="Happy" cf-label="Happy 🙂" />
    <input type="checkbox" name="mood[]" value="Depression" cf-label="Depression 😔" />
    <input type="checkbox" name="mood[]" value="Easy" cf-label="Easy 😇" />
    <input type="checkbox" name="mood[]" value="Anger" cf-label="Anger 😠" />
    <input type="checkbox" name="mood[]" value="Engaged" cf-label="Engaged 🧐" />
    <input type="checkbox" name="mood[]" value="Frustration" cf-label="Frustration 😤" />
    <input type="checkbox" name="mood[]" value="Managable" cf-label="Managable😬" />
  </fieldset>
         <cf-robot-message cf-questions="We really appreciate all the hard work you are putting in and we will get through this together. Take good care of yourself until then."></cf-robot-message>
     <cf-robot-message cf-questions="Byeee!"></cf-robot-message>
      <input type="text" name="survey1" value="<?php echo $surveycode;?>" style="display:none">
       <input type="text" name="project_id" value="<?php echo $project_id;?>" style="display:none">
        <!-- <input type="text" name="question_list" value="?php echo $question_list;?>" style="display:none">
 ...
 <div id="cf-context" class="dark-theme" role="cf-context" cf-context></div>
     <div id="cf-context123" class="dark-theme" role="cf-context" cf-context></div>
